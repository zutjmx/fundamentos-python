...
print(f"* Base de Datos: {database.info().name}\n")
...
print(f"* Colección: {collection.full_name}\n")
...
print(f"* {len(insertion_result.inserted_ids)} registros insertados.\n")
...
print("Resultados de la búsqueda por vector:")
